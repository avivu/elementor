...
const frontendEntries = {
	...
	'background-video-embed-handler': path.resolve( __dirname, '../modules/atomic-widgets/elements/atomic-background-video-embed/handlers/atomic-background-video-embed-handler.js' ),
