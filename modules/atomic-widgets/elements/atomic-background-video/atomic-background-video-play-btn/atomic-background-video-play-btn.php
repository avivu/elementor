...
class Atomic_Background_Video_Play_Btn extends Atomic_Element_Base {
	...
	public static function get_type() {
		return 'e-background-video-play-btn';
	}
	...
	public function get_keywords() {
		return [ 'ato', 'atom', 'atoms', 'atomic', 'video', 'play', 'button' ];
	}
	...
	protected function build_template_context(): array {
		return array_merge( $this->build_base_template_context(), [
			'aria_label' => esc_attr__( 'Play video', 'elementor' ),
		] );
	}

	protected function get_templates(): array {
		return [
			'elementor/elements/atomic-background-video-play-btn' => __DIR__ . '/atomic-background-video-play-btn.html.twig',
		];
	}
}
